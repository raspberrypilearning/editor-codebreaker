...
You will encode or decode a secret message from a .txt file. Letter data can be displayed in a frequency graph, which shows how often each letter appears in the secret message.
